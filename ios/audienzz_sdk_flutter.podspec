...
Flutter wrapper for Audienzz Mobile SDK
  ...
  # AudienzziOSSDK 0.3.2 requires Google-Mobile-Ads-SDK 13 and uses
  # PrebidMobile's UserUniqueID(uniqueId:) (3.3.1+); GMAS 13 raises the min iOS
  # deployment target to 15. 0.3.2 builds against stock PrebidMobile (no fork).
  s.dependency 'Google-Mobile-Ads-SDK', '~> 13.0'
  s.dependency 'AudienzziOSSDK', '~> 0.3.2'
  s.platform = :ios, '15.0'
