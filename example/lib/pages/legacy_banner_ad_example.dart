// This file is an exact copy of banner_ad_example.dart from SDK v0.0.10.
// Used to verify backward compatibility — no code changes made.
...
class LegacyBannerAdExample extends StatefulWidget {
  const LegacyBannerAdExample({super.key});

  @override
  State<LegacyBannerAdExample> createState() => _LegacyBannerAdExampleState();
}

class _LegacyBannerAdExampleState extends State<LegacyBannerAdExample> {
